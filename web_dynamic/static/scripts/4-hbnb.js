$(function () {
    ...
    const url = 'http://127.0.0.1:5500/api/v1/status/';
    ...
    $('button').click(function() {
      $.ajax({
        url: 'http://127.0.0.1:5500/api/v1/places_search/',
        type: 'POST',
        data: JSON.stringify({ amenities: new_list }), // Send the list of amenities
        dataType: 'json',
